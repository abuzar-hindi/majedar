    ...
    <footer className="w-full bg-[#11261B] text-stone-300 pt-12 pb-8 border-t border-stone-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <span className="font-hero font-bold text-white text-xl tracking-wider uppercase">MAJEDAR</span>
            </div>
        ...
        <div className="border-t border-stone-800/80 pt-6 text-center text-xs text-stone-500">
          &copy; {new Date().getFullYear()} MAJEDAR RESTAURANT — All rights reserved.
        </div>
      </div>
    </footer>
  );
