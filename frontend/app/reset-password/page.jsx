...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(
        err?.message || "Invalid code or failed to reset password. Please try again."
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      toast.info("Password reset code resent!", { autoClose: 2500 });
    } catch (err) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="123456"
              required
              className={`${inputClass} tracking-widest text-center text-lg font-mono font-bold`}
            />
          </div>
