    ...
    <section className="w-full bg-[#F2F7F4] py-14 sm:py-20 border-b border-stone-200/60">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-stone-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto mb-8 font-normal">
          ...
          <b>straight to your table or doorstep</b>. Our chefs prepare each meal
          with love and attention to detail,{" "}
          <i> ensuring that every bite is a celebration of taste</i>. Experience
          the essence of traditional cooking, made fresh for you every day.
        </p>
