...
const CATEGORY_ITEMS = [
  {
    name: "Breakfast",
    image: "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "South Indian",
  ...
  {
    name: "Momos",
    image: "https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "Maggi",
  ...
  {
    name: "Pasta",
    image: "https://images.unsplash.com/photo-1621996346565-e3d5d6281270?auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "Rice & Biryani",
  ...
  {
    name: "Roti & Papad",
    image: "https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "Pizza",
                ...
                <div
                  className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden mb-2.5 transition-all duration-300 border-2 ${
                    isActive
                      ...
                      : "border-stone-200/90 group-hover:border-stone-300 group-hover:scale-103"
