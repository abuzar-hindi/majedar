...
export const metadata = {
  ...
  description: "Visit Majedar Restaurant in Faizabad, UP. Ram Path, Sahabganj. Open daily 11AM-11:30PM. Call +91 7905404619.",
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white rounded-2xl border border-stone-200/80 overflow-hidden shadow-2xs min-h-[380px] flex">
            <iframe
              title="Majedar Restaurant Location Map"
